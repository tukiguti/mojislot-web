...
| リーチ目 | 各リールに**ボーナス役にしか使わない図柄**があり、非ボーナス時は停止制御が中段に止めない。**中段に出たらボーナス確定**（持ち越し中の73〜100%で出現） |
...
- **リーチ目と持ち越し**：ボーナスをこぼしても**フラグは消えず**（実機Aタイプ）、以降は演出も告知も出ない。代わりに**リーチ目**が出る——各リールには「ボーナス役にしか使わない図柄」があり、停止テーブルが**非ボーナス時はそれを中段に止めない**よう組んであるので、**中段に出た＝ボーナス確定**になる。持ち越し中の73〜100%で出現し、読めた人はそこから自力で揃えに行く
