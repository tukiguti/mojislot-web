...
| **BIG** | 18G＋α ／ 平均 **113〜307枚**（腕による） |
| **REG** | 8G＋α ／ 平均 **50〜133枚** |
| 合算突入率 | **1/78 〜 1/150**（腕による） |
| ゲーム数上乗せ（おかわり） | **上限なし** |
| 通常時の純増 | **−0.97 〜 +1.07枚/G**（＝ほぼ増えない。実機のコイン持ちに相当） |
| ボーナス中の純増 | **+3.1 〜 +12.8枚/G**（出玉はここに集約） |
| **機械割** | **78% 〜 194%** ─ 設定ではなく、**腕（目押し＋押し順）で変動** |
...
|---|---|---|---|---|---|---|
| 初心者（±100ms / 75%） | **78%** | −0.97枚 | +3.1枚 | 1/150 | 113枚 | 45% |
| 中級（±50ms / 92%） | **108%** | −0.35枚 | +5.5枚 | 1/116 | 158枚 | 61% |
| 上級（±25ms / 100%） | **142%** | +0.26枚 | +8.3枚 | 1/96 | 213枚 | 74% |
| 神（±10ms / 100%） | **194%** | +1.07枚 | +12.8枚 | 1/78 | 307枚 | 85% |
